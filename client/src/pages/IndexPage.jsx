...
export default function IndexPage() {
  const { user } = useContext(UserContext); // Check if the user is logged in
  ...
  const EventSlideshow = () => {
    const settings = {
      ...
      autoplaySpeed: 3000,
      arrows: true,
      // Custom arrow styling to match your design
      prevArrow: <CustomPrevArrow />,
      nextArrow: <CustomNextArrow />,
      // Ensures full-width image display
    ...
    <>
      <div className="mt-1 flex flex-col">
        ...
        <div href="#" className="flex item-center inset-0">
            <img src="../src/assets/index_page.jpg" alt="" className="w-full h-full object-cover" />
          </div>
        </div>
              ...
              if (eventDate > currentDate || eventDate.toDateString() === currentDate.toDateString()) {
                return (
                  <div className="bg-white rounded-xl relative" key={event._id}>
                    ...
                    <img
                      src="../src/assets/event_welcome.jpg"
                      alt=""
